    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="<?= base_url(uri_string()) == base_url('Admin') ? 'active' : ''; ?> nav-item"><a href="<?= base_url('Admin')?>"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Kelola Sistem</span></a>
                    <ul class="menu-content">
                        <li class="<?= base_url(uri_string()) == base_url('Admin/kelola_murid') ? 'active' : ''; ?>"><a href="<?= base_url('Admin/kelola_murid') ?>"><i></i><span class="menu-item" data-i18n="2 columns">Kelola data murid</span></a>
                        </li>
                        <li class="<?= base_url(uri_string()) == base_url('Admin/kelola_guru') ? 'active' : ''; ?>"><a href="<?= base_url('Admin/kelola_guru') ?>"><i></i><span class="menu-item" data-i18n="Fixed navbar">Kelola data guru</span></a>
                        </li>
                    </ul>
                </li>
                <li class="<?= base_url(uri_string()) == base_url('Admin/tentang_app') ? 'active' : ''; ?> nav-item"><a href="<?= base_url('Admin/tentang_app')?>"><i class="feather icon-info"></i><span class="menu-title" data-i18n="About">Tentang</span></a>
                </li>
